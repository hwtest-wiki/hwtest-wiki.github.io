...
- [42 · 同样是 256G 手机，为什么有的秒开大型游戏、有的卡到怀疑人生？——UFS：把 eMMC 的并行老总线换成 MIPI M-PHY 串行，一致性测法为什么和显示家族"分了家"](/articles/42) 🔧
- [40 · 同样一根 HDMI 线，为什么有的能 4K120 / 8K、有的一插就花屏黑屏？——HDMI：从 TMDS 到 FRL，测法怎么跟着传输机制换了一套](/articles/40) 🔧
- [39 · 同样一根 USB-C 线，为什么有的 100W 快充、有的只有 5V？——USB-C / USB PD：一致性测试里唯一不看眼图的一篇](/articles/39) 🔧
- [38 · 同样是 USB，为什么 10G 的眼图在示波器上直接是「闭」的？——USB 3.x 超速，一致性测试真正的深水区](/articles/38) 🔧
- [37 · 插移动硬盘就掉速？3000 个比特叠成一只「眼」，USB 2.0 就靠它判生死——眼高差 23 毫伏，这根线就贴不上 USB logo](/articles/37) 🔧
- [36 · 一条走线好好的，眼图却塌了——TDR 怎么像"给走线做 B 超"，一眼揪出坏在第几厘米？](/articles/36) 🔧
